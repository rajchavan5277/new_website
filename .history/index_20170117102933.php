...
$URL_VAR_NUM = explode("/" , $_SERVER['REQUEST_URI']);
define('URL_VAR_NUM' , 3); //3 on local 2 on production 
...
}else if($urlVariable[URL_VAR_NUM3] == 'gallary'){
   require_once 'gallery.php';
}else if($urlVariable[URL_VAR_NUM] == 'about-us'){
   require_once "about-us.php";
}else if($urlVariable[URL_VAR_NUM3] =='service'){
